...
@section('title', 'Mercedes-Benz Cars - RideHub')
    ...
    <div class="flex flex-col h-full">
        ...
        <div class="flex-1 px-3 py-4 overflow-y-auto">
            <ul class="space-y-2">
                ...
                <li>
                    <a href="{{ route('cars.benz') }}" class="flex items-center p-2 text-gray-900 dark:text-white rounded-lg bg-gray-100 dark:bg-gray-700">
                        <svg class="w-5 h-5 text-gray-500 dark:text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<main class="ml-64 min-h-screen bg-gray-50 dark:bg-gray-900">
    <div class="p-4 sm:p-6 lg:p-8">
        <div class="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Mercedes-Benz Cars</h1>
            <button onclick="openAddCarModal()" class="w-full sm:w-auto inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
        <div class="relative bg-white dark:bg-gray-800 rounded-lg max-w-lg w-full p-6 shadow-xl">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add New Mercedes-Benz</h3>
            ...
            <form id="addCarForm" class="space-y-4">
                @csrf
                <input type="hidden" name="brand" value="benz">
        ...
        if (data.success) {
            ...
            carElement.innerHTML = `
                ...
                <div class="p-4">
                    ...
                    <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-2">$${parseFloat(car.selling_price).toLocaleString('en-US', {minimumFractionDigits: 2})}</p>
                    ...
                    <div class="mt-4 flex gap-2">
                        <a href="/cars/${car.id}" 
                           class="flex-1 inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">
